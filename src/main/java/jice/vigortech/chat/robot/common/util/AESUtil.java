...
public class AESUtil
{
    ...
    {
        System.out.println(AESUtil.encForTD("ADMIN"));
        System.out.println(AESUtil.encrypt("haha",SysConstants.SYS_TOKEN_SALT));
        System.out.println(AESUtil.decrypt("/7tEoIIjofXabcilk7roZw==", SysConstants.SYS_TOKEN_SALT));
    }
    ...
    {
        return encrypt(sSrc, "tospurexmindcomp");
    }
    ...
    {
        return decrypt(sSrc, "tospurexmindcomp");
    }
